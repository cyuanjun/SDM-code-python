...
class GenerateReportPage:
    ...
    def display_report(report) -> None:
        st.success(
            "\n\n".join([
                f"**{report.report_type.title()} report generated: "
                f"{report.report_id}**",
                f"**Window:** {report.start_date.isoformat()} → "
                f"{report.end_date.isoformat()}",
                f"**Generated at:** {report.generated_at.isoformat()}",
                f"**Generated by:** {report.platform_manager_id}",
                f"**Donations:** {report.total_donation_count} "
                f"(${report.total_donation_amount} total)",
                f"**Activities:** {report.total_activity_count}",
                f"**Fundraisers:** {report.total_fundraiser_count}",
                f"**Donees:** {report.total_donee_count}",
            ])
        )
